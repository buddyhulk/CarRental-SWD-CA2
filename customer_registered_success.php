...
$customer_name = filter_var($conn->real_escape_string($_POST['customer_name']));
$customer_username = filter_var($conn->real_escape_string($_POST['customer_username']));
$customer_email = filter_var($conn->real_escape_string($_POST['customer_email']), FILTER_SANITIZE_EMAIL);
$customer_phone = filter_var($conn->real_escape_string($_POST['customer_phone']));
$customer_address = filter_var($conn->real_escape_string($_POST['customer_address']));
$customer_password = password_hash(filter_var($_POST['customer_password']), PASSWORD_BCRYPT);


if (!isPasswordComplex($_POST['customer_password'])) {
