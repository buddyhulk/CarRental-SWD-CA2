...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="#"><span class="glyphicon glyphicon-user"></span> Welcome <?php echo htmlspecialchars($_SESSION['login_client']); ?></a>
                    </li>
                    <li>
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="#"><span class="glyphicon glyphicon-user"></span> Welcome <?php echo htmlspecialchars($_SESSION['login_customer']); ?></a>
                    </li>
                    <li>
                        <a href="#">History</a>
                    </li>
    ...
    <div class="container" style="margin-top: -2%; margin-bottom: 2%;">
        <div class="col-md-5 col-md-offset-4">
            <label style="margin-left: 5px;color: red;"><span> <?php echo htmlspecialchars($error);  ?> </span></label>
