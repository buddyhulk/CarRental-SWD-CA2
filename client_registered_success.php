...
$client_name = filter_var($conn->real_escape_string($_POST['client_name']));
$client_name = filter_var($conn->real_escape_string($_POST['client_name']));
$client_username = filter_var($conn->real_escape_string($_POST['client_username']));
$client_email = filter_var($conn->real_escape_string($_POST['client_email']), FILTER_SANITIZE_EMAIL);
$client_phone = filter_var($conn->real_escape_string($_POST['client_phone']));
$client_address = filter_var($conn->real_escape_string($_POST['client_address']));
$client_password = password_hash($_POST['client_password'], PASSWORD_BCRYPT);

if (!isPasswordComplex($_POST['client_password'])) {
...
$stmt->bind_param("ssssss", $client_name, $client_username, $client_email, $client_phone, $client_address, $client_password);
