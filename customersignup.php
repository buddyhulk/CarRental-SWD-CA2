...
<body>
    ...
    <div class="container">
        <div class="jumbotron">
            ...
            <br>
            <p class="text-center">Get started by creating a customer account</p>
        </div>
    </div>
                    ...
                    <form role="form" action="customer_registered_success.php" method="POST">
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                ...
                                <div class="input-group">
                                    <input class="form-control" id="customer_name" type="text" name="customer_name" placeholder="Your Full Name" required pattern="[A-Za-z ]+" title="Only alphabets and spaces are allowed" autofocus>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                ...
                                <div class="input-group">
                                    <input class="form-control" id="customer_username" type="text" name="customer_username" placeholder="Your Username" required pattern="[A-Za-z0-9]+" title="Only alphanumeric characters are allowed">
                                    <span class="input-group-btn">
                                        <label class="btn btn-primary"><span class="glyphicon glyphicon-user" aria-hidden="true"></span></label>
                                    </span>
                                </div>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                ...
                                <div class="input-group">
                                    <input class="form-control" id="customer_phone" type="tel" name="customer_phone" placeholder="Phone" required pattern="[0-9]{10}" title="Please enter a valid 10-digit phone number">
                                    <span class="input-group-btn">
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                ...
                                <div class="input-group">
                                    <input class="form-control" id="customer_address" type="text" name="customer_address" placeholder="Address" required pattern="[A-Za-z0-9 ]+" title="Only alphanumeric characters and spaces are allowed">
                                    <span class="input-group-btn">
